...
import numpy as np
from rl_data_analayze_json import RobotStatistics
...
class rl_DataPlotter:
    def __init__(self, obs_num = 10,xlim = (-5.5, 6.5),ylim = (-5.5, 6.5),eps_list = [i for i in range(1000)],show_figures=True):
        ...
        with open(self.path+"data_collected_plot_"+str(obs_num)+"d.json") as f:
    ...
    def data_process(self,data_eps, odom_data_eps, dynamic_obstacle_data_eps,ctrl_network_points_data_eps,convex_polygon_data_eps):
        ...
        index_set = set([1,40,50,60]) # ,101,112
        ...
        steps = []
        index_set = set([5, 5, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 15, 15, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 28, 28, 29, 29, 30, 30, 31, 31, 33, 33, 34, 34, 35, 35, 36, 36, 37, 37, 38, 38, 39, 39, 40, 40, 41, 41, 42, 42, 43, 43, 44, 44, 45, 45, 46, 46, 47, 47, 48, 48, 49, 49, 50, 50, 51, 51, 54, 54, 55, 55, 56, 56, 57, 57, 58, 58, 59, 59, 60, 60, 61, 61, 62, 62, 63, 63, 64, 64])
