...
class RobotStatistics:
    ...
    def get_finished_eps(self):
        return {eps: data for eps, data in self.eps_data.items() if
...
if __name__ == '__main__':
    stats = RobotStatistics(
        r'D:\RL\data\231217 reward对比实验\reward_func_test_231213\reward_test_d30\all_reward\test_2\reward_test_analyze_all_reward_d30 copy.json')
