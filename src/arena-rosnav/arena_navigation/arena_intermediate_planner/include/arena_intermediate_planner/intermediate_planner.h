...
#include <arena_intermediate_planner/Global_Kino_MakePlan.h>
...
private:
    ...
    // publisher
    ros::Publisher kino_astar_path_pub_,kino_astar_traj_pub_,global_plan_pub_;
...
public:
    ...
    bool makeGlobalPlan(arena_intermediate_planner::Global_Kino_MakePlan::Request  &req, arena_intermediate_planner::Global_Kino_MakePlan::Response &res);
