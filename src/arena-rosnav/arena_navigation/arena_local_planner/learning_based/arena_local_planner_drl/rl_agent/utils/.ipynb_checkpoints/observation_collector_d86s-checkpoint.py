...
class ObservationCollector_d86:
    ...
    def normalize_obs(self,g2d_cal_success,scan,polar_convex,theta,rho,pdtheta,prho,wvx,wvy,last_polar_action_and_opt_action):
        ...
        if g2d_cal_success and len(polar_convex) == self.laser_num_beams:
        ...
        return np.array(n_scan),np.array(n_polar_convex),ntheta,nrho,npdtheta,nprho,nwvx,nwvy,n_polar_action_rad,n_polar_action_dist,n_opt_polar_action_rad,n_opt_polar_action_dist
