...
from geometry_msgs.msg import Pose2D, PoseWithCovarianceStamped, PoseStamped,Twist
...
class RobotManager:
    ...
    def _spawn_robot(self, robot_yaml_path: str):
        ...
        # try:
        #     rospy.wait_for_service(f"{self.ns_prefix}spawn_model",timeout=2.)
        # except rospy.ROSException:
        #     print(self.ns+"_spawn timeout")
    ...
    def move_robot(self, pose: Pose2D):
        ...
        action_msg = Twist()
        # try:
        #     rospy.wait_for_service(f"{self.ns_prefix}move_model",timeout=2.)
        # except rospy.ROSException:
        #     print(self.ns+"_move timeout")
        try:
        ...
        action_msg.angular.z = self.step_size # + 0.00001
        ...
        #     except rospy.ROSException:
        #         # rospy.logwarn("next step time out")
        #         time.sleep(0.1)
        #         continue
        # time.sleep(0.03)
        ...
        while i_try < max_try_times:
            ...
            if start_pos is None:
                ...
                (
                    ...
                    start_pos_.y,
                    start_pos_.theta,
                ) = get_random_pos_on_map(self._free_space_indices, self.map, self.ROBOT_RADIUS * 2 + 0.05)
            else:
            ...
            quaternion = self.quaternion_from_euler(0, 0, 0)

            goal.pose.orientation.w = quaternion[0]
            goal.pose.orientation.x = start_pos_.x
            goal.pose.orientation.y = start_pos_.y
            ...
            #     # rospy.wait_for_service(self.ns_prefix + "global_kino_make_plan")
            #     break
    ...
    def _validate_path(self):
        ...
        with self._global_path_con:
            self._global_path_con.wait_for(predicate=self._new_global_path_generated, timeout=0.3)
